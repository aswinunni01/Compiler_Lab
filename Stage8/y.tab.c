...
union YYSTYPE
{
#line 41 "Compiler/staticalloc.y"
...
{
       0,    61,    61,    70,    79,    88,    98,   109,   117,   127,
     128,   131,   132,   135,   141,   142,   145,   146,   149,   152,
     153,   156,   163,   169,   178,   191,   194,   194,   197,   204,
     211,   214,   220,   221,   222,   223,   231,   231,   234,   234,
     237,   251,   252,   253,   254,   268,   274,   280,   286,   296,
     302,   309,   315,   326,   327,   329,   339,   343,   346,   349,
     352,   353,   356,   357,   365,   369,   375,   381,   382,   385,
     394,   398,   405,   406,   409,   412,   413,   416,   417,   418,
     419,   420,   421,   422,   423,   424,   425,   426,   427,   430,
     433,   437,   440,   441,   442,   443,   444,   445,   446,   447,
     448,   449,   450,   451,   470,   479,   492,   493,   494,   495,
     508,   520,   521,   524,   525,   529,   548,   568,   596,   623,
     651,   663,   694
};
#endif
...
#line 61 "Compiler/staticalloc.y"
                                                                        {
...
#line 70 "Compiler/staticalloc.y"
                                                           {
...
#line 79 "Compiler/staticalloc.y"
                                            {
...
#line 88 "Compiler/staticalloc.y"
                                                      {
...
#line 98 "Compiler/staticalloc.y"
                                             {
...
#line 109 "Compiler/staticalloc.y"
                                         {
...
#line 117 "Compiler/staticalloc.y"
...
#line 163 "Compiler/staticalloc.y"
...
#line 169 "Compiler/staticalloc.y"
...
#line 178 "Compiler/staticalloc.y"
...
#line 191 "Compiler/staticalloc.y"
                                                {}
#line 1792 "y.tab.c"
    break;

  case 27: /* TypeDefList: TypeDef  */
#line 194 "Compiler/staticalloc.y"
                                                {}
#line 1798 "y.tab.c"
    break;

  case 28: /* TypeDef: ID '{' FieldDeclList '}'  */
#line 197 "Compiler/staticalloc.y"
                                                { 
...
#line 204 "Compiler/staticalloc.y"
...
#line 211 "Compiler/staticalloc.y"
                                                {  FieldNo = 0; (yyval.fl)=(yyvsp[0].fl); }
#line 1825 "y.tab.c"
    break;

  case 31: /* FieldDecl: TypeName ID ';'  */
#line 214 "Compiler/staticalloc.y"
                                 { 
...
#line 220 "Compiler/staticalloc.y"
                    { (yyval.Tentry) = "INT"; }
#line 1840 "y.tab.c"
    break;

  case 33: /* TypeName: STR  */
#line 221 "Compiler/staticalloc.y"
                    { (yyval.Tentry) = "STR"; }
#line 1846 "y.tab.c"
    break;

  case 34: /* TypeName: VOID  */
#line 222 "Compiler/staticalloc.y"
                     { (yyval.Tentry) = "VOID"; }
#line 1852 "y.tab.c"
    break;

  case 35: /* TypeName: ID  */
#line 223 "Compiler/staticalloc.y"
                    {  (yyval.Tentry) = (yyvsp[0].no)->varname; }
#line 1858 "y.tab.c"
    break;

  case 37: /* GdeclBlock: DECL ENDDECL  */
#line 231 "Compiler/staticalloc.y"
                                                   {}
#line 1864 "y.tab.c"
    break;

  case 39: /* GdeclList: Gdecl  */
#line 234 "Compiler/staticalloc.y"
                                    {}
#line 1870 "y.tab.c"
    break;

  case 40: /* Gdecl: Type GidList ';'  */
#line 237 "Compiler/staticalloc.y"
                                        { 
...
#line 268 "Compiler/staticalloc.y"
                                        {
...
#line 274 "Compiler/staticalloc.y"
                                        {
...
#line 280 "Compiler/staticalloc.y"
                                              { 
...
#line 286 "Compiler/staticalloc.y"
                                                {
                                                if(Lookup((yyvsp[-3].no)->varname)!=NULL){
...
#line 296 "Compiler/staticalloc.y"
                                        { 
						if(Lookup((yyvsp[-3].no)->varname) != NULL){
			                                yyerror("Variable name already declared");
			                                exit(1);}
...
#line 302 "Compiler/staticalloc.y"
                                        {
						if(Lookup((yyvsp[-6].no)->varname) != NULL){
			                                yyerror("Variable name already declared");
			                                exit(1);}
...
#line 1985 "y.tab.c"
  ...
  case 51: /* GidList: ID  */
#line 309 "Compiler/staticalloc.y"
                                        {
						 if(Lookup((yyvsp[0].no)->varname) != NULL){
							yyerror("Variable name already declared");
							exit(1);}	
...
#line 315 "Compiler/staticalloc.y"
                                        {
						if(Lookup((yyvsp[-3].no)->varname)!=NULL){
							yyerror("Function name already declared");
							exit(1);}
...
#line 339 "Compiler/staticalloc.y"
...
#line 343 "Compiler/staticalloc.y"
                                        { 
...
#line 365 "Compiler/staticalloc.y"
                                        {	if (Cptr != NULL){
...
#line 369 "Compiler/staticalloc.y"
                                        {
						if (Cptr != NULL){
                                               	 	Linstall("self", TLookup("VOID"), ploc--);
                                                }
...
#line 375 "Compiler/staticalloc.y"
                                        { if (Cptr != NULL){
                                                        Linstall("self", TLookup("VOID"), ploc--);
                                                }
					}
...
#line 381 "Compiler/staticalloc.y"
                                        {}
#line 2124 "y.tab.c"
    break;

  case 68: /* LDecList: LDecl  */
#line 382 "Compiler/staticalloc.y"
                                        {}
#line 2130 "y.tab.c"
    break;

  case 69: /* LDecl: TypeName IdList ';'  */
#line 385 "Compiler/staticalloc.y"
...
#line 394 "Compiler/staticalloc.y"
...
#line 2151 "y.tab.c"
  ...
  case 71: /* IdList: ID  */
#line 398 "Compiler/staticalloc.y"
                                        { if(Llookup((yyvsp[0].no)->varname)!=NULL){
                                                yyerror("Local variable already declared");
                                                exit(1);} 
...
#line 2370 "y.tab.c"
  ...
  case 104: /* E: ID '[' E ']'  */
#line 470 "Compiler/staticalloc.y"
                 { if(Lookup((yyvsp[-3].no)->varname) == NULL){
                        yyerror("Variable not declared\n");
                        exit(1); }
...
#line 2383 "y.tab.c"
  ...
  case 105: /* E: ID '[' E ']' '[' E ']'  */
#line 479 "Compiler/staticalloc.y"
                           { if(Lookup((yyvsp[-6].no)->varname)==NULL){
...
#line 2400 "y.tab.c"
  ...
  case 106: /* E: NUM  */
#line 492 "Compiler/staticalloc.y"
                { (yyval.no) = (yyvsp[0].no); }
#line 2406 "y.tab.c"
    break;

  case 107: /* E: LIT  */
#line 493 "Compiler/staticalloc.y"
                { (yyval.no) = (yyvsp[0].no); }
#line 2412 "y.tab.c"
    break;

  case 108: /* E: NUL  */
#line 494 "Compiler/staticalloc.y"
                { (yyval.no) = createTree(0, TLookup("VOID"), NULL, 0, NULL, NULL, NULL, NULL); }
#line 2418 "y.tab.c"
    break;

  case 109: /* E: ID '(' ')'  */
#line 495 "Compiler/staticalloc.y"
                        {
...
#line 508 "Compiler/staticalloc.y"
                                { 
				if(Lookup((yyvsp[-3].no)->varname) == NULL){
					yyerror("Function not declared before calling \n");
					exit(1);
...
#line 2452 "y.tab.c"
  ...
  case 111: /* E: Field  */
#line 520 "Compiler/staticalloc.y"
                                { (yyval.no) = (yyvsp[0].no); }
#line 2458 "y.tab.c"
    break;

  case 112: /* E: Method  */
#line 521 "Compiler/staticalloc.y"
                                { (yyval.no) = (yyvsp[0].no); }
#line 2464 "y.tab.c"
    break;

  case 113: /* ArgList: ArgList ',' E  */
#line 524 "Compiler/staticalloc.y"
                                { (yyvsp[0].no)->middle = (yyvsp[-2].no); (yyval.no)=(yyvsp[0].no);}
#line 2470 "y.tab.c"
    break;

  case 114: /* ArgList: E  */
#line 525 "Compiler/staticalloc.y"
                                { (yyval.no)=(yyvsp[0].no); }
#line 2476 "y.tab.c"
    break;

  case 115: /* Method: SELF '.' ID '(' ArgList ')'  */
#line 529 "Compiler/staticalloc.y"
                                     {
       					if(Cptr == NULL){
...
#line 548 "Compiler/staticalloc.y"
                              {
					if(Cptr == NULL){
                                        yyerror("Self cannot be used outside a class");
                                        exit(1);}
...
#line 568 "Compiler/staticalloc.y"
...
#line 596 "Compiler/staticalloc.y"
                                    { 
...
#line 623 "Compiler/staticalloc.y"
                            {
...
#line 651 "Compiler/staticalloc.y"
...
#line 663 "Compiler/staticalloc.y"
...
#line 694 "Compiler/staticalloc.y"
                        {
				if(Cptr == NULL){
					yyerror("Self cannot be used outside a class");
					exit(1);}
...
#line 714 "Compiler/staticalloc.y"
